...
Conductor was written and is maintained by [James Golick]{http://jamesgolick.com} for use at fetlife.com (NSFW). It is distributable under the terms of the MIT License.
